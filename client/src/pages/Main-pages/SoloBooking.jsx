...
import useSolo from '../../hooks/packages/useSolo';


const SoloBooking = () => {
    const { solo, isLoading } = useSolo()
    useEffect(() => {
    ...
    const generalPackage = solo?.filter((pkg) => pkg.packageType === "solo" && pkg.customizablePackage === false)
    const customizePackage = solo?.filter((pkg) => pkg.packageType === "solo" && pkg.customizablePackage === true)
        ...
        <div className='Adventure'>
            ...
            <div className='packages'>
                <div className="heading">
                    <h1>Solo Travelling Packages</h1>
                </div>
